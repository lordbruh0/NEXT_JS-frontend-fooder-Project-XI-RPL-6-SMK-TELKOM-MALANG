...
const FileInput = (props: Props) => {
    ...
    return (
        <div className="w-full flex flex-col gap-1 my-2 p-4 border rounded-sm bg-white">
            <strong className="text-lg font-medium">{props.label}</strong>
            <input type={`file`} className={`text-sm w-full rounded-md p-2 focus:border-[rgb(193,193,193)] border-[rgb(193,193,193)] focus:outline-none ${props.className}`}
